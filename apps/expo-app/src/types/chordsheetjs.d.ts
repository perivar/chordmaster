...
// Definitions by: Per Ivar Nerseth, based on Adam Bloom <https://github.com/adamsbloom>

declare module "chordsheetjsDISABLED" {
  export class Chord {
  ...
  export class Line {
    ...
    /**
     * The items (ChordLyricsPair, Tag or Comment) of which the line consists
     */
    items: (ChordLyricsPair | Tag | Comment)[];
  ...
  export class ChordSheetParser {
    ...
    initialize(document: string, { song }: { song?: Song } = {}): void;
    readLine(): string;
    hasNextLine(): boolean;
  ...
  /**
   * Parses a UltimateGuitar chord sheet
   * Just extend ChordSheetParser
   */
