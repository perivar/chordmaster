...
type PlaylistViewScreenRouteProp = RouteProp<
  RootStackParamList,
  "PlaylistView"
>;
...
const PlaylistView: FunctionComponent<Props> = (props: Props) => {
  ...
  const onSelectSong = (id: string, title: string) => {
    navigation.navigate("SongView", { id, title });
  };

  const onPressEditSong = (id: string) => {
    navigation.navigate("SongEdit", { id });
  };
  ...
  const onPressAddSongs = () => {
    navigation.navigate("PlaylistAddSongs", { id: playlistIdParam });
  };

  const onPressEditPlaylist = () => {
    navigation.navigate("PlaylistEdit", { id: playlistIdParam });
  };
